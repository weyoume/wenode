...
{
   public:
      database_api(const ezira::app::api_context& ctx);
      ~database_api();
...
FC_REFLECT( ezira::app::order, (order_price)(real_price)(ezira)(EZD)(created) );
...
FC_REFLECT( ezira::app::withdraw_route, (from_account)(to_account)(percent)(auto_vest) );

FC_REFLECT( ezira::app::discussion_query, (tag)(filter_tags)(select_tags)(select_authors)(truncate_body)(start_author)(start_permlink)(parent_author)(parent_permlink)(limit) );

FC_REFLECT_ENUM( ezira::app::withdraw_route_type, (incoming)(outgoing)(all) );

FC_API(ezira::app::database_api,
   // Subscriptions
