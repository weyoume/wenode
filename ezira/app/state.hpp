...
namespace ezira { namespace app {
   ...
   struct  discussion : public comment_api_obj {
      ...
      asset                       promoted = asset(0, EZD_SYMBOL);
...
FC_REFLECT_DERIVED( ezira::app::extended_account,
                   (ezira::app::account_api_obj),
...
FC_REFLECT( ezira::app::vote_state, (voter)(weight)(rshares)(percent)(reputation)(time) );
FC_REFLECT( ezira::app::account_vote, (authorperm)(weight)(rshares)(percent)(time) );

FC_REFLECT( ezira::app::discussion_index, (category)(trending)(payout)(payout_comments)(trending30)(updated)(created)(responses)(active)(votes)(maturing)(best)(hot)(promoted)(cashout) )
FC_REFLECT( ezira::app::tag_index, (trending) )
FC_REFLECT_DERIVED( ezira::app::discussion, (ezira::app::comment_api_obj), (url)(root_title)(pending_payout_value)(total_pending_payout_value)(active_votes)(replies)(author_reputation)(promoted)(body_length)(reblogged_by)(first_reblogged_by)(first_reblogged_on) )
...
FC_REFLECT( ezira::app::order_history_item, (time)(type)(EZD_quantity)(ezira_quantity)(real_price) );
