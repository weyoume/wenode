...
of a running WeYouMe Debug Node. The Debug Node is a plugin for WeYouMe that allows realtime
...
[Python WeYouMe library](https://github.com/xeroc/python-eznetworklib).
...
To use the script include `from WeYouMedebugnode import DebugNode`

There are a couple of examples already made that you can try modifying yourself.

[debug_hardforks.py](https://github.com/WeYouMe/WeYouMe/python_scripts/tests/debug_hardforks.py)
...
[debugnode.py](https://github.com/WeYouMe/WeYouMe/python_scripts/nodedebugnode/nodedebugnode.py#L212)
