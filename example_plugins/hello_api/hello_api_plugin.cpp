...
namespace node { namespace example_plugin {

class hello_api_plugin : public node::app::plugin
{
   public:
      /**
       ...
       */
      hello_api_plugin( node::app::application* app );
...
{
   public:
      hello_api_api( const node::app::api_context& ctx );
...
FC_API( node::example_plugin::hello_api_api,
   (get_message)
   )

namespace node { namespace example_plugin {

hello_api_plugin::hello_api_plugin( node::app::application* app ) : node::app::plugin(app) {}
...
hello_api_api::hello_api_api( const node::app::api_context& ctx ) : _app(ctx.app) {}
...
/**
 * The DEFINE_PLUGIN() macro will define a node::plugin::create_hello_api_plugin()
 * factory method which is expected by the manifest.
 */

DEFINE_PLUGIN( hello_api, node::example_plugin::hello_api_plugin )
