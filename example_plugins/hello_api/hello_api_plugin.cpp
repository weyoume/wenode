...
class hello_api_plugin : public ezira::app::plugin
{
   public:
      /**
       ...
       */
      hello_api_plugin( ezira::app::application* app );
...
{
   public:
      hello_api_api( const ezira::app::api_context& ctx );
...
FC_API( ezira::example_plugin::hello_api_api,
   (get_message)
   )

namespace ezira { namespace example_plugin {

hello_api_plugin::hello_api_plugin( ezira::app::application* app ) : ezira::app::plugin(app) {}
...
hello_api_api::hello_api_api( const ezira::app::api_context& ctx ) : _app(ctx.app) {}
