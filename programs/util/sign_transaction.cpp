...
struct tx_signing_result
{
   ...
   node::protocol::public_key_type key;
   node::protocol::signature_type  sig;
};
...
int main(int argc, char** argv, char** envp)
{
   ...
   while( std::cin )
   {
      ...
      sres.key = node::protocol::public_key_type( priv_key.get_public_key() );
