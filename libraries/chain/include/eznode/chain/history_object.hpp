...
FC_REFLECT( eznode::chain::operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op) )
CHAINBASE_SET_INDEX_TYPE( eznode::chain::operation_object, eznode::chain::operation_index )

FC_REFLECT( eznode::chain::account_history_object, (id)(account)(sequence)(op) )
CHAINBASE_SET_INDEX_TYPE( eznode::chain::account_history_object, eznode::chain::account_history_index )
