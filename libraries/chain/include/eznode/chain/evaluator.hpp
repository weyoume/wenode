...
template< typename OperationType=eznode::protocol::operation >
class evaluator
{
   public:
...
template< typename EvaluatorType, typename OperationType=eznode::protocol::operation >
...
class X ## _evaluator : public eznode::chain::evaluator_impl< X ## _evaluator > \
{                                                                           \
   public:                                                                  \
      typedef X ## _operation operation_type;                               \
                                                                            \
      X ## _evaluator( database& db )                                       \
         : eznode::chain::evaluator_impl< X ## _evaluator >( db )          \
      {}                                                                    \
                                                                            \
