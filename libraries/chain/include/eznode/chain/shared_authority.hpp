...
namespace ezira { namespace chain {
   ...
   using eznode::protocol::weight_type;
...
FC_REFLECT_TYPENAME( eznode::chain::shared_authority::account_authority_map)
FC_REFLECT( eznode::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
