...
namespace ezira { namespace chain {
   ...
   using eznode::protocol::asset_symbol_type;
...
FC_REFLECT_ENUM( eznode::chain::curve_id,
                  (quadratic)(quadratic_curation)(linear)(square_root))

FC_REFLECT( eznode::chain::limit_order_object,
             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
CHAINBASE_SET_INDEX_TYPE( eznode::chain::limit_order_object, eznode::chain::limit_order_index )

FC_REFLECT( eznode::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( eznode::chain::feed_history_object, eznode::chain::feed_history_index )

FC_REFLECT( eznode::chain::convert_request_object,
...
CHAINBASE_SET_INDEX_TYPE( eznode::chain::savings_withdraw_object, eznode::chain::savings_withdraw_index )
...
FC_REFLECT( eznode::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( eznode::chain::decline_voting_rights_request_object, eznode::chain::decline_voting_rights_request_index )

FC_REFLECT( eznode::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
