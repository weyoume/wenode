...
namespace eznode { namespace chain {
   ...
   using eznode::protocol::chain_properties;
   using eznode::protocol::digest_type;
   using eznode::protocol::public_key_type;
   using eznode::protocol::version;
   using eznode::protocol::hardfork_version;
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         /**
          * This field represents the Ezira blockchain version the witness is running.
          */
...
FC_REFLECT_ENUM( eznode::chain::witness_object::witness_schedule_type, (top19)(timeshare)(miner)(none) )

FC_REFLECT( eznode::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( eznode::chain::witness_object, eznode::chain::witness_index )

FC_REFLECT( eznode::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( eznode::chain::witness_vote_object, eznode::chain::witness_vote_index )

FC_REFLECT( eznode::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE( eznode::chain::witness_schedule_object, eznode::chain::witness_schedule_index )
