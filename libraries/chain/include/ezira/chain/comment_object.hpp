...
FC_REFLECT( ezira::chain::comment_object,
             (id)(author)(permlink)
...
CHAINBASE_SET_INDEX_TYPE( ezira::chain::comment_object, ezira::chain::comment_index )

FC_REFLECT( ezira::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( ezira::chain::comment_vote_object, ezira::chain::comment_vote_index )
