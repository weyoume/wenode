...
FC_REFLECT( eznode::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( eznode::chain::transaction_object, eznode::chain::transaction_index )
