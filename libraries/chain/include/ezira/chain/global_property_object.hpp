...
FC_REFLECT( ezira::chain::dynamic_global_property_object,
             (id)
             (head_block_number)
             (head_block_id)
             (time)
...
CHAINBASE_SET_INDEX_TYPE( ezira::chain::dynamic_global_property_object, ezira::chain::dynamic_global_property_index )
