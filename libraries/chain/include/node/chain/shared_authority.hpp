...
namespace node { namespace chain {
   ...
   using node::protocol::weight_type;
...
FC_REFLECT_TYPENAME( node::chain::shared_authority::account_authority_map)
FC_REFLECT( node::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
