...
template< typename OperationType=node::protocol::operation >
class evaluator
{
   public:
...
template< typename EvaluatorType, typename OperationType=node::protocol::operation >
...
class X ## _evaluator : public node::chain::evaluator_impl< X ## _evaluator > \
{                                                                           \
   public:                                                                  \
      typedef X ## _operation operation_type;                               \
                                                                            \
      X ## _evaluator( database& db )                                       \
         : node::chain::evaluator_impl< X ## _evaluator >( db )          \
      {}                                                                    \
                                                                            \
