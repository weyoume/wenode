...
namespace node { namespace chain {
   ...
   class confidential_balance_object : public object< confidential_balance_object_type, confidential_balance_object >
   {
      ...
      public:
         ...
         public_key_type          spend_key;           ///< Public key able to spend the balance.
         
         asset                    amount;              ///< The amount of asset stored in the balance.
         ...
         digest_type              hash()const          ///< Hash of the balance.
         {
            ...
            fc::raw::pack( enc, spend_key );
            fc::raw::pack( enc, amount );
            fc::raw::pack( enc, created );
            return enc.result();
         }

         asset_symbol_type        asset_type()const    ///< Symbol of the amount balance.
         {
      ...
      indexed_by<
         ...
         ordered_unique< tag< by_key >,
            composite_key< confidential_balance_object,
               member< confidential_balance_object, public_key_type, &confidential_balance_object::spend_key >,
