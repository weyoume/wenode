...
DEFINE_EVALUATOR( account_connection_request )
DEFINE_EVALUATOR( account_connection_accept )
...
DEFINE_EVALUATOR( community_federation_request )
DEFINE_EVALUATOR( community_federation_accept )
