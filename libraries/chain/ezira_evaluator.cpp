...
{ try {
   ...
   if( _db.has_hardfork( HARDFORK_0_14__259 ) )
   {
      FC_ASSERT( abs_rshares > VOTE_DUST_THRESHOLD || o.weight == 0, "Voting weight is too small, please accumulate more voting power or ezira power." );
   }
   else if( _db.has_hardfork( HARDFORK_0_13__248 ) )
   {
      FC_ASSERT( abs_rshares > VOTE_DUST_THRESHOLD || abs_rshares == 1, "Voting weight is too small, please accumulate more voting power or ezira power." );
   }
...
void convert_evaluator::do_apply( const convert_operation& o )
{
  ...
  auto ezira_conversion_delay = CONVERSION_DELAY_PRE_HF_16;
  if( _db.has_hardfork( HARDFORK_0_16__551) )
     ezira_conversion_delay = CONVERSION_DELAY;
