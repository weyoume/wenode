...
FC_REFLECT( ezira::app::comment_api_obj,
             (id)(author)(permlink)
...
FC_REFLECT( ezira::app::account_api_obj,
             ...
             (reward_EZD_balance)(reward_ezira_balance)(reward_vesting_balance)(reward_vesting_ezira)
...
FC_REFLECT( ezira::app::owner_authority_history_api_obj,
             (id)
             (account)
...
FC_REFLECT( ezira::app::account_recovery_request_api_obj,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( ezira::app::savings_withdraw_api_obj,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( ezira::app::feed_history_api_obj,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( ezira::app::tag_api_obj,
            (name)
            (total_payouts)
            (net_votes)
            (top_posts)
...
FC_REFLECT( ezira::app::witness_api_obj,
             (id)
             (owner)
             (created)
...
FC_REFLECT_DERIVED( ezira::app::signed_block_api_obj, (ezira::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT_DERIVED( ezira::app::dynamic_global_property_api_obj, (ezira::chain::dynamic_global_property_object),
