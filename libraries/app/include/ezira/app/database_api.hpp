...
{
   public:
      database_api(const eznode::app::api_context& ctx);
      ~database_api();
      ...
      /**
       * @breif Gets the current order book for ECO:EZD market
...
FC_REFLECT_ENUM( eznode::app::withdraw_route_type, (incoming)(outgoing)(all) );

FC_API(eznode::app::database_api,
   // Subscriptions
