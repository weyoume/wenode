...
FC_REFLECT( eznode::app::owner_authority_history_api_obj,
             (id)
             (account)
...
FC_REFLECT( eznode::app::savings_withdraw_api_obj,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( eznode::app::feed_history_api_obj,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( eznode::app::tag_api_obj,
            (name)
            (total_payouts)
            (net_votes)
            (top_posts)
...
FC_REFLECT( eznode::app::witness_api_obj,
             (id)
             (owner)
             (created)
...
FC_REFLECT_DERIVED( eznode::app::signed_block_api_obj, (eznode::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT_DERIVED( eznode::app::dynamic_global_property_api_obj, (eznode::chain::dynamic_global_property_object),
