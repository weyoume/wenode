#pragma once
#include <eznode/app/applied_operation.hpp>
...
FC_REFLECT_DERIVED( eznode::app::discussion, (eznode::app::comment_api_obj), (url)(root_title)(pending_payout_value)(total_pending_payout_value)(active_votes)(replies)(author_reputation)(promoted)(body_length)(reblogged_by)(first_reblogged_by)(first_reblogged_on) )
