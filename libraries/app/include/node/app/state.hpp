...
FC_REFLECT( node::app::vote_state, (voter)(weight)(ESCORreward)(percent)(reputation)(time) );
FC_REFLECT( node::app::account_vote, (authorperm)(weight)(ESCORreward)(percent)(time) );
...
FC_REFLECT( node::app::order_history_item, (time)(type)(EUSD_quantity)(ECO_quantity)(real_price) );
...
FC_REFLECT( node::app::candle_stick, (open_time)(period)(high)(low)(open)(close)(ECO_volume)(EUSD_volume) );
