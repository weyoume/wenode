...
fc::variant_object get_config()
{
   ...
   result["SYMBOL_TSD"] = SYMBOL_TSD;
   result["PERCENT_100"] = PERCENT_100;
   result["PERCENT_1"] = PERCENT_1;
   result["PERCENT_10_OF_PERCENT_1"] = PERCENT_10_OF_PERCENT_1;
   result["ACCOUNT_RELATERCOVERY_REQUEST_EXPIRATION_PERIOD"] = ACCOUNT_RELATERCOVERY_REQUEST_EXPIRATION_PERIOD;
   ...
   result["BANDWIDTH_AVERAGE_WINDOW_SELATERCONDS"] = BANDWIDTH_AVERAGE_WINDOW_SELATERCONDS;
   ...
   result["CASHOUT_WINDOW_SELATERCONDS"] = CASHOUT_WINDOW_SELATERCONDS;
   result["CASHOUT_WINDOW_SELATERCONDS_PRE_HF12"] = CASHOUT_WINDOW_SELATERCONDS_PRE_HF12;
   result["CASHOUT_WINDOW_SELATERCONDS_PRE_HF17"] = CASHOUT_WINDOW_SELATERCONDS_PRE_HF17;
   ...
   result["CREATE_ACCOUNT_WITH_TME_MODIFIER"] = CREATE_ACCOUNT_WITH_TME_MODIFIER;
   result["CURATE_APR_PERCENT"] = CURATE_APR_PERCENT;
   result["DEFAULT_TSD_INTEREST_RATE"] = DEFAULT_TSD_INTEREST_RATE;
   ...
   result["MAX_accountWitnessVoteS"] = MAX_accountWitnessVoteS;
   ...
   result["MAX_CASHOUT_WINDOW_SELATERCONDS"] = MAX_CASHOUT_WINDOW_SELATERCONDS;
   result["MAX_COMMENT_DEPTH"] = MAX_COMMENT_DEPTH;
   result["MAX_COMMENT_DEPTH_PRE_HF17"] = MAX_COMMENT_DEPTH_PRE_HF17;
   result["MAX_FEED_AGE_SELATERCONDS"] = MAX_FEED_AGE_SELATERCONDS;
   ...
   result["MAX_SCORE_SUPPLY"] = MAX_SCORE_SUPPLY;
   ...
   result["MIN_PAYOUT_TSD"] = MIN_PAYOUT_TSD;
   ...
   result["OWNER_AUTH_RELATERCOVERY_PERIOD"] = OWNER_AUTH_RELATERCOVERY_PERIOD;
   ...
   result["TSD_INTEREST_COMPOUND_INTERVAL_SEC"] = TSD_INTEREST_COMPOUND_INTERVAL_SEC;
   result["SELATERCONDS_PER_YEAR"] = SELATERCONDS_PER_YEAR;
   result["RECENT_RSCORE_DECAY_RATE_HF19"] = RECENT_RSCORE_DECAY_RATE_HF19;
   result["RECENT_RSCORE_DECAY_RATE_HF17"] = RECENT_RSCORE_DECAY_RATE_HF17;
   result["REVERSE_AUCTION_WINDOW_SELATERCONDS"] = REVERSE_AUCTION_WINDOW_SELATERCONDS;
   ...
   result["TSD_START_PERCENT"] = TSD_START_PERCENT;
   result["TSD_STOP_PERCENT"] = TSD_STOP_PERCENT;
   result["SELATERCOND_CASHOUT_WINDOW"] = SELATERCOND_CASHOUT_WINDOW;
   result["SOFT_MAX_COMMENT_DEPTH"] = SOFT_MAX_COMMENT_DEPTH;
   result["START_MINER_VOTING_BLOCK"] = START_MINER_VOTING_BLOCK;
   result["START_TME_fund_for_SCORE_BLOCK"] = START_TME_fund_for_SCORE_BLOCK;
   ...
   result["SCORE_fund_PERCENT"] = SCORE_fund_PERCENT;
   result["TME_fund_for_SCORE_WITHDRAW_INTERVALS"] = TME_fund_for_SCORE_WITHDRAW_INTERVALS;
   result["TME_fund_for_SCORE_WITHDRAW_INTERVALS_PRE_HF_16"] = TME_fund_for_SCORE_WITHDRAW_INTERVALS_PRE_HF_16;
   result["SCORE_WITHDRAW_INTERVAL_SELATERCONDS"] = SCORE_WITHDRAW_INTERVAL_SELATERCONDS;
   result["VOTE_CHANGE_LOCKOUT_PERIOD"] = VOTE_CHANGE_LOCKOUT_PERIOD;
   result["VOTE_DUST_THRESHOLD"] = VOTE_DUST_THRESHOLD;
   result["VOTE_REGENERATION_SELATERCONDS"] = VOTE_REGENERATION_SELATERCONDS;
   result["SYMBOL_TME"] = SYMBOL_TME;
   result["SYMBOL_SCORE"] = SYMBOL_SCORE;
