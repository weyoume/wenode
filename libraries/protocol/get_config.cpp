...
fc::variant_object get_config()
{
   ...
   result["CREATE_ACCOUNT_WITH_ECO_MODIFIER"] = CREATE_ACCOUNT_WITH_ECO_MODIFIER;
   result["CURATE_APR_PERCENT"] = CURATE_APR_PERCENT;
   result["DEFAULT_EUSD_INTEREST_RATE"] = DEFAULT_EUSD_INTEREST_RATE;
   ...
   result["MAX_ESCOR_SUPPLY"] = MAX_ESCOR_SUPPLY;
   ...
   result["MIN_PAYOUT_EUSD"] = MIN_PAYOUT_EUSD;
   ...
   result["EUSD_INTEREST_COMPOUND_INTERVAL_SEC"] = EUSD_INTEREST_COMPOUND_INTERVAL_SEC;
   result["SECONDS_PER_YEAR"] = SECONDS_PER_YEAR;
   result["RECENT_RESCOR_DECAY_RATE_HF19"] = RECENT_RESCOR_DECAY_RATE_HF19;
   result["RECENT_RESCOR_DECAY_RATE_HF17"] = RECENT_RESCOR_DECAY_RATE_HF17;
   ...
   result["EUSD_START_PERCENT"] = EUSD_START_PERCENT;
   result["EUSD_STOP_PERCENT"] = EUSD_STOP_PERCENT;
   ...
   result["START_ECO_fund_for_ESCOR_BLOCK"] = START_ECO_fund_for_ESCOR_BLOCK;
   ...
   result["ESCOR_fund_PERCENT"] = ESCOR_fund_PERCENT;
   result["ECO_fund_for_ESCOR_WITHDRAW_INTERVALS"] = ECO_fund_for_ESCOR_WITHDRAW_INTERVALS;
   result["ECO_fund_for_ESCOR_WITHDRAW_INTERVALS_PRE_HF_16"] = ECO_fund_for_ESCOR_WITHDRAW_INTERVALS_PRE_HF_16;
   result["ESCOR_WITHDRAW_INTERVAL_SECONDS"] = ESCOR_WITHDRAW_INTERVAL_SECONDS;
   ...
   result["SYMBOL_ESCOR"] = SYMBOL_ESCOR;
