...
fc::variant_object get_config()
{
   ...
   result["MAX_REVENUE_SHARE"] = MAX_REVENUE_SHARE;
   ...
   result["INIT_BUSINESS"] = INIT_BUSINESS;
   result["INIT_GOVERNANCE"] = INIT_GOVERNANCE;

   result["INIT_PUBLIC_COMMUNITY"] = INIT_PUBLIC_COMMUNITY;
   result["INIT_PRIVATE_COMMUNITY"] = INIT_PRIVATE_COMMUNITY;
   result["GOVERNANCE_PUBLIC_COMMUNITY"] = GOVERNANCE_PUBLIC_COMMUNITY;
   result["GOVERNANCE_PRIVATE_COMMUNITY"] = GOVERNANCE_PRIVATE_COMMUNITY;
   result["GOVERNANCE_EQUITY_SYMBOL"] = GOVERNANCE_EQUITY_SYMBOL;
   result["GOVERNANCE_CREDIT_SYMBOL"] = GOVERNANCE_CREDIT_SYMBOL;
