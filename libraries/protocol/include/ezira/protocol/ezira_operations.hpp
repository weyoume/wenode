...
FC_REFLECT( ezira::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( ezira::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( ezira::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( ezira::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( ezira::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( ezira::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( ezira::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( ezira::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( ezira::protocol::pow, (worker)(input)(signature)(work) )
FC_REFLECT( ezira::protocol::pow2, (input)(pow_summary) )
FC_REFLECT( ezira::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
FC_REFLECT( ezira::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( ezira::protocol::chain_properties, (account_creation_fee)(maximum_block_size)(EZD_interest_rate) );

FC_REFLECT_TYPENAME( ezira::protocol::pow2_work )
FC_REFLECT( ezira::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
FC_REFLECT( ezira::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( ezira::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( ezira::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( ezira::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( ezira::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( ezira::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( ezira::protocol::withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( ezira::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
FC_REFLECT( ezira::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( ezira::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( ezira::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( ezira::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( ezira::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( ezira::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( ezira::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( ezira::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( ezira::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( ezira::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( ezira::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( ezira::protocol::delete_comment_operation, (author)(permlink) );
...
FC_REFLECT( ezira::protocol::escrow_transfer_operation, (from)(to)(EZD_amount)(ezira_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
...
FC_REFLECT( ezira::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(EZD_amount)(ezira_amount) );
...
FC_REFLECT( ezira::protocol::claim_reward_balance_operation, (account)(reward_ezira)(reward_EZD)(reward_vests) )
