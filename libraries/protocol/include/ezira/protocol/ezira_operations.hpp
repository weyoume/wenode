...
namespace ezira { namespace protocol {
   ...
   struct chain_properties
   {
      ...
      uint16_t          sbd_interest_rate  = EZIRA_DEFAULT_SBD_INTEREST_RATE;
      ...
      void validate()const
      {
         ...
         FC_ASSERT( sbd_interest_rate <= EZIRA_100_PERCENT );
      }
   };
   ...
   /**
    *  This operation instructs the blockchain to start a conversion between EZIRA and SBD,
...
FC_REFLECT( ezira::protocol::chain_properties, (account_creation_fee)(maximum_block_size)(sbd_interest_rate) );
