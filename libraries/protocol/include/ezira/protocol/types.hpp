...
FC_REFLECT( ezira::protocol::public_key_type, (key_data) )
FC_REFLECT( ezira::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( ezira::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( ezira::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( ezira::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( ezira::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( ezira::protocol::share_type )

FC_REFLECT( ezira::void_t, )
