...
} } // namespace ezira::protocol


FC_REFLECT_TYPENAME( ezira::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( ezira::protocol::authority::key_authority_map)
FC_REFLECT( ezira::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( ezira::protocol::authority::classification, (owner)(active)(key)(posting) )
