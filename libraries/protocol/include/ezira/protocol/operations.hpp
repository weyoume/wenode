...
/*namespace fc {
    void to_variant( const ezira::protocol::operation& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  ezira::protocol::operation& vo );
}*/

DECLARE_OPERATION_TYPE( ezira::protocol::operation )
FC_REFLECT_TYPENAME( ezira::protocol::operation )
