...
namespace ezira { namespace protocol {
   ...
   struct author_reward_operation : public virtual_operation {
      ...
      author_reward_operation( const account_name_type& a, const string& p, const asset& s, const asset& st, const asset& v )
         :author(a), permlink(p), sbd_payout(s), ezira_payout(st), vesting_payout(v){}
...
FC_REFLECT( ezira::protocol::author_reward_operation, (author)(permlink)(sbd_payout)(ezira_payout)(vesting_payout) )
FC_REFLECT( ezira::protocol::curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( ezira::protocol::comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( ezira::protocol::fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( ezira::protocol::liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( ezira::protocol::interest_operation, (owner)(interest) )
FC_REFLECT( ezira::protocol::fill_vesting_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( ezira::protocol::shutdown_witness_operation, (owner) )
FC_REFLECT( ezira::protocol::fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( ezira::protocol::fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( ezira::protocol::hardfork_operation, (hardfork_id) )
FC_REFLECT( ezira::protocol::comment_payout_update_operation, (author)(permlink) )
FC_REFLECT( ezira::protocol::return_vesting_delegation_operation, (account)(vesting_shares) )
FC_REFLECT( ezira::protocol::comment_benefactor_reward_operation, (benefactor)(author)(permlink)(reward) )
FC_REFLECT( ezira::protocol::producer_reward_operation, (producer)(vesting_shares) )
