...
namespace ezira { namespace protocol {
   ...
   struct author_reward_operation : public virtual_operation {
      ...
      author_reward_operation( const account_name_type& a, const string& p, const asset& s, const asset& st, const asset& v )
         :author(a), permlink(p), EZD_payout(s), ezira_payout(st), vesting_payout(v){}
...
FC_REFLECT( ezira::protocol::author_reward_operation, (author)(permlink)(EZD_payout)(ezira_payout)(vesting_payout) )
