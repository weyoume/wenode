...
namespace node { namespace protocol {
   ...
   /**
    * Contains block information to facilitate network consensus:
    * 
    * - Previous Block
    * - Timestamp
    * - Block producer
...
FC_REFLECT( node::protocol::block_header, 
         (previous)
         (timestamp)
         (producer)
...
FC_REFLECT_DERIVED( node::protocol::signed_block_header, (node::protocol::block_header), 
         (producer_signature) 
         );