...
FC_REFLECT_TYPENAME( node::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( node::protocol::authority::key_authority_map)
FC_REFLECT( node::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( node::protocol::authority::classification, (owner)(active)(key)(posting) )
