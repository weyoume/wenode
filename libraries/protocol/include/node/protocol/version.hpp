...
/*
 * This class represents the basic versioning scheme of the WeYouMe blockchain.
...
{
   class variant;
   void to_variant( const node::protocol::version& v, variant& var );
   void from_variant( const variant& var, node::protocol::version& v );

   void to_variant( const node::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, node::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( node::protocol::version, (v_num) )
FC_REFLECT_DERIVED( node::protocol::hardfork_version, (node::protocol::version), )

FC_REFLECT( node::protocol::hardfork_version_vote, (hf_version)(hf_time) )
