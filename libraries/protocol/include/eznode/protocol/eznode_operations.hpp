...
FC_REFLECT( eznode::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( eznode::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( eznode::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( eznode::protocol::pow, (worker)(input)(signature)(work) )
