...
} } // namespace eznode::protocol


FC_REFLECT_TYPENAME( eznode::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( eznode::protocol::authority::key_authority_map)
FC_REFLECT( eznode::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( eznode::protocol::authority::classification, (owner)(active)(key)(posting) )
