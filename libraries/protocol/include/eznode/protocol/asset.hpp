...
namespace fc {
    inline void to_variant( const eznode::protocol::asset& var,  fc::variant& vo ) { vo = var.to_string(); }
    inline void from_variant( const fc::variant& var,  eznode::protocol::asset& vo ) { vo = eznode::protocol::asset::from_string( var.as_string() ); }
}

FC_REFLECT( eznode::protocol::asset, (amount)(symbol) )
FC_REFLECT( eznode::protocol::price, (base)(quote) )
