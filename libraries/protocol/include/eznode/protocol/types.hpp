...
namespace eznode {
   ...
   namespace protocol {
      ...
      #define INIT_PUBLIC_KEY (eznode::protocol::public_key_type(INIT_PUBLIC_KEY_STR))
...
FC_REFLECT( eznode::protocol::public_key_type, (key_data) )
FC_REFLECT( eznode::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( eznode::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( eznode::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( eznode::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( eznode::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( eznode::protocol::share_type )

FC_REFLECT( eznode::void_t, )
