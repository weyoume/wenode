...
FC_REFLECT( node::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( node::account_by_key::key_lookup_object, node::account_by_key::key_lookup_index )
