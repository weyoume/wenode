...
FC_REFLECT( eznode::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( eznode::account_by_key::key_lookup_object, eznode::account_by_key::key_lookup_index )
