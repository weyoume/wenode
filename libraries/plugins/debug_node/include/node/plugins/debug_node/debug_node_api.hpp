...
{
   public:
      debug_node_api( const node::app::api_context& ctx );
...
FC_REFLECT( node::plugin::debug_node::get_dev_key_args,
   (name)
   )

FC_REFLECT( node::plugin::debug_node::get_dev_key_result,
   (private_key)
   (public_key)
   )
...
FC_REFLECT( node::plugin::debug_node::debug_mine_result,
   )

FC_API(node::plugin::debug_node::debug_node_api,
       (debug_push_blocks)
