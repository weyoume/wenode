...
debug_node_api_impl::debug_node_api_impl( node::app::application& _app ) : app( _app )
{
   ...
   {
      node::protocol::private_key_type private_owner_key = node::protocol::get_private_key( acct_itr->name, OWNER_KEY_STR, INIT_PASSWORD );
      node::protocol::private_key_type private_active_key = node::protocol::get_private_key( acct_itr->name, ACTIVE_KEY_STR, INIT_PASSWORD );
      node::protocol::private_key_type private_posting_key = node::protocol::get_private_key( acct_itr->name, POSTING_KEY_STR, INIT_PASSWORD );
      node::protocol::private_key_type private_secure_key = node::protocol::get_private_key( acct_itr->name, SECURE_KEY_STR, INIT_PASSWORD );
      node::protocol::private_key_type private_connection_key = node::protocol::get_private_key( acct_itr->name, CONNECTION_KEY_STR, INIT_PASSWORD );
      node::protocol::private_key_type private_friend_key = node::protocol::get_private_key( acct_itr->name, FRIEND_KEY_STR, INIT_PASSWORD );
      node::protocol::private_key_type private_companion_key = node::protocol::get_private_key( acct_itr->name, COMPANION_KEY_STR, INIT_PASSWORD );
      node::protocol::private_key_type private_producer_key = node::protocol::get_private_key( acct_itr->name, PRODUCER_KEY_STR, INIT_PASSWORD );
