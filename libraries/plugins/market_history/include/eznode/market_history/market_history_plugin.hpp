...
class market_history_plugin : public eznode::app::plugin
{
   public:
...
FC_REFLECT( eznode::market_history::order_history_object,
                     ...
                     (time)
                     (op) )
CHAINBASE_SET_INDEX_TYPE( eznode::market_history::order_history_object, eznode::market_history::order_history_index )
