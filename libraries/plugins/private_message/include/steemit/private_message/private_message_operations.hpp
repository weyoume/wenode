...
struct private_message_operation : public ezira::protocol::base_operation
{
...
FC_REFLECT( ezira::private_message::private_message_operation, (from)(to)(from_memo_key)(to_memo_key)(sent_time)(checksum)(encrypted_message) )

DECLARE_OPERATION_TYPE( ezira::private_message::private_message_plugin_operation )
FC_REFLECT_TYPENAME( ezira::private_message::private_message_plugin_operation )
