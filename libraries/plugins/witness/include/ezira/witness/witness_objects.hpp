...
FC_REFLECT_ENUM( ezira::witness::bandwidth_type, (post)(forum)(market) )

FC_REFLECT( ezira::witness::account_bandwidth_object,
            (id)(account)(type)(average_bandwidth)(lifetime_bandwidth)(last_bandwidth_update) )
CHAINBASE_SET_INDEX_TYPE( ezira::witness::account_bandwidth_object, ezira::witness::account_bandwidth_index )

FC_REFLECT( ezira::witness::content_edit_lock_object,
            (id)(account)(lock_time) )
CHAINBASE_SET_INDEX_TYPE( ezira::witness::content_edit_lock_object, ezira::witness::content_edit_lock_index )

FC_REFLECT( ezira::witness::reserve_ratio_object,
            (id)(average_block_size)(current_reserve_ratio)(max_virtual_bandwidth) )
CHAINBASE_SET_INDEX_TYPE( ezira::witness::reserve_ratio_object, ezira::witness::reserve_ratio_index )
