...
FC_REFLECT_ENUM( eznode::witness::bandwidth_type, (post)(forum)(market) )

FC_REFLECT( eznode::witness::account_bandwidth_object,
            (id)(account)(type)(average_bandwidth)(lifetime_bandwidth)(last_bandwidth_update) )
CHAINBASE_SET_INDEX_TYPE( eznode::witness::account_bandwidth_object, eznode::witness::account_bandwidth_index )

FC_REFLECT( eznode::witness::content_edit_lock_object,
            (id)(account)(lock_time) )
CHAINBASE_SET_INDEX_TYPE( eznode::witness::content_edit_lock_object, eznode::witness::content_edit_lock_index )

FC_REFLECT( eznode::witness::reserve_ratio_object,
            (id)(average_block_size)(current_reserve_ratio)(max_virtual_bandwidth) )
CHAINBASE_SET_INDEX_TYPE( eznode::witness::reserve_ratio_object, eznode::witness::reserve_ratio_index )
