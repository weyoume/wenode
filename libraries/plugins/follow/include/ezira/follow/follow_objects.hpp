...
/**
 *  This index is maintained to get an idea of which authors are reeziraed by a particular blogger and
 ...
 *  Give me all blog posts by [authors] that were reeziraed by this blog
 */
...
FC_REFLECT_ENUM( eznode::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( eznode::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( eznode::follow::follow_object, eznode::follow::follow_index )

FC_REFLECT( eznode::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( eznode::follow::feed_object, eznode::follow::feed_index )

FC_REFLECT( eznode::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id) )
CHAINBASE_SET_INDEX_TYPE( eznode::follow::blog_object, eznode::follow::blog_index )

FC_REFLECT( eznode::follow::reputation_object, (id)(account)(reputation) )
CHAINBASE_SET_INDEX_TYPE( eznode::follow::reputation_object, eznode::follow::reputation_index )

FC_REFLECT( eznode::follow::follow_count_object, (id)(account)(follower_count)(following_count) )
CHAINBASE_SET_INDEX_TYPE( eznode::follow::follow_count_object, eznode::follow::follow_count_index )

FC_REFLECT( eznode::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( eznode::follow::blog_author_stats_object, eznode::follow::blog_author_stats_index );
