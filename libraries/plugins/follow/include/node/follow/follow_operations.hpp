...
FC_REFLECT( node::follow::follow_operation, (follower)(following)(what) )
FC_REFLECT( node::follow::reblog_operation, (account)(author)(permlink) )

DECLARE_OPERATION_TYPE( node::follow::follow_plugin_operation )

FC_REFLECT_TYPENAME( node::follow::follow_plugin_operation )
