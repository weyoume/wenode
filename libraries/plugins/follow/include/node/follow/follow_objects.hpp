...
/**
 *  This index is maintained to get an idea of which authors are reWeYouMeed by a particular blogger and
 ...
 *  Give me all blog posts by [authors] that were reWeYouMeed by this blog
 */
...
FC_REFLECT_ENUM( node::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( node::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( node::follow::follow_object, node::follow::follow_index )

FC_REFLECT( node::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( node::follow::feed_object, node::follow::feed_index )

FC_REFLECT( node::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id) )
CHAINBASE_SET_INDEX_TYPE( node::follow::blog_object, node::follow::blog_index )

FC_REFLECT( node::follow::reputation_object, (id)(account)(reputation) )
CHAINBASE_SET_INDEX_TYPE( node::follow::reputation_object, node::follow::reputation_index )

FC_REFLECT( node::follow::follow_count_object, (id)(account)(follower_count)(following_count) )
CHAINBASE_SET_INDEX_TYPE( node::follow::follow_count_object, node::follow::follow_count_index )

FC_REFLECT( node::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( node::follow::blog_author_stats_object, node::follow::blog_author_stats_index );
