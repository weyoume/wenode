...
struct by_net_SCOREreward; /// all comments regardless of depth
struct by_parent_created;
struct by_parent_active;
struct by_parent_promoted;
struct by_parent_net_SCOREreward; /// all top level posts by direct pending payout
...
struct by_reward_fund_net_SCOREreward;
struct by_comment;
struct by_tag;
...
typedef multi_index_container<
   ...
   indexed_by<
      ...
      >,
      ordered_unique< tag< by_parent_net_SCOREreward >,
            composite_key< tag_object,
               member< tag_object, tag_name_type, &tag_object::tag >,
               member< tag_object, comment_id_type, &tag_object::parent >,
               member< tag_object, int64_t, &tag_object::net_SCOREreward >,
               member< tag_object, tag_id_type, &tag_object::id >
            >,
      ...
      >,
      ordered_unique< tag< by_net_SCOREreward >,
            composite_key< tag_object,
               member< tag_object, tag_name_type, &tag_object::tag >,
               member< tag_object, int64_t, &tag_object::net_SCOREreward >,
               member< tag_object, tag_id_type, &tag_object::id >
      ...
      >,
      ordered_unique< tag< by_reward_fund_net_SCOREreward >,
            composite_key< tag_object,
               member< tag_object, tag_name_type, &tag_object::tag >,
...
class tag_stats_object : public object< tag_stats_object_type, tag_stats_object >
{
   public:
      ...
      tag_name_type     tag;
      asset             total_payout = asset( 0, SYMBOL_TSD );
      int32_t           net_votes = 0;
 ...
 *  a user votes on a post, the relationship between voter and author increases direct SCOREreward.
 */
...
class author_tag_stats_object : public object< author_tag_stats_object_type, author_tag_stats_object >
{
  public:
      ...
      account_id_type author;
      tag_name_type   tag;
      asset           total_rewards = asset( 0, SYMBOL_TSD );
...
FC_REFLECT( node::tags::tag_object,
   (id)(tag)(created)(active)(cashout)(net_SCOREreward)(net_votes)(hot)(trending)(promoted_balance)(children)(author)(parent)(comment) )
