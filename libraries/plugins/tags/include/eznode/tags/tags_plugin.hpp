...
class tag_stats_object : public object< tag_stats_object_type, tag_stats_object >
{
   public:
      ...
      tag_name_type     tag;
      asset             total_payout = asset( 0, SYMBOL_EUSD );
      int32_t           net_votes = 0;
...
class author_tag_stats_object : public object< author_tag_stats_object_type, author_tag_stats_object >
{
  public:
      ...
      account_id_type author;
      tag_name_type   tag;
      asset           total_rewards = asset( 0, SYMBOL_EUSD );
 ...
 *
 */
class tags_plugin : public eznode::app::plugin
{
   public:
...
CHAINBASE_SET_INDEX_TYPE( eznode::tags::tag_stats_object, eznode::tags::tag_stats_index )

FC_REFLECT( eznode::tags::peer_stats_object,
   (id)(voter)(peer)(direct_positive_votes)(direct_votes)(indirect_positive_votes)(indirect_votes)(rank) );
CHAINBASE_SET_INDEX_TYPE( eznode::tags::peer_stats_object, eznode::tags::peer_stats_index )

FC_REFLECT( eznode::tags::comment_metadata, (tags) );

FC_REFLECT( eznode::tags::author_tag_stats_object, (id)(author)(tag)(total_posts)(total_rewards) )
CHAINBASE_SET_INDEX_TYPE( eznode::tags::author_tag_stats_object, eznode::tags::author_tag_stats_index )
