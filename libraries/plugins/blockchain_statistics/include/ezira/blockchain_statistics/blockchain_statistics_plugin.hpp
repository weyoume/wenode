...
class blockchain_statistics_plugin : public ezira::app::plugin
{
   public:
...
FC_REFLECT( ezira::blockchain_statistics::bucket_object,
   (id)
   (open)
   (seconds)
   (blocks)
...
CHAINBASE_SET_INDEX_TYPE( ezira::blockchain_statistics::bucket_object, ezira::blockchain_statistics::bucket_index )
