...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           author_rewards_total_steem_value = 0;     ///< EZIRA Value of author rewards
   ...
   share_type           curation_rewards_steem_value = 0;         ///< EZIRA Value of curation rewards
   ...
   share_type           steem_sent = 0;                           ///< EZIRA sent from this account
   share_type           steem_received = 0;                       ///< EZIRA received by this account
   ...
   share_type           steem_vested = 0;                         ///< EZIRA vested by the account
   ...
   share_type           steem_received_from_withdrawls = 0;       ///< EZIRA received from this account's vesting withdrawals
   share_type           steem_received_from_routes = 0;           ///< EZIRA received from another account's vesting withdrawals
   ...
   share_type           steem_converted = 0;                      ///< Amount of EZIRA that was converted
   ...
   share_type           limit_order_steem_paid = 0;               ///< EZIRA paid by limit orders
   share_type           limit_order_steem_received = 0;           ///< EZIRA received from limit orders
