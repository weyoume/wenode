...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           assets_sent = 0;                             ///< assets sent from this account
   share_type           assets_received = 0;                         ///< assets received by this account
   uint32_t             asset_stake_transfers = 0;                 ///< Transfers by this account.
   share_type           asset_stake_value = 0;                         ///< value in staked balances of the account
   uint32_t             asset_unstake_transfers = 0;             ///< New fund withdrawal requests
   uint32_t             asset_unstake_adjustments = 0;            ///< Changes to fund withdraw requests
   uint32_t             asset_unstake_withdrawals = 0;           ///< fund withdrawals processed for this account
   uint32_t             asset_unstake_completed = 0;             ///< Processed fund withdrawals that are now finished
   share_type           total_assets_unstaked = 0;                      ///< withdrawn from the account
   share_type           assets_received_from_withdrawls = 0;       ///< received from this account's fund withdrawals
   share_type           assets_received_from_routes = 0;           ///< received from another account's fund withdrawals
   share_type           assets_received_from_routes = 0;           ///< assets received from another account's fund withdrawal
   ...
   share_type           limit_order_assets_paid = 0;               ///< assets paid by limit orders
   share_type           limit_order_assets_received = 0;           ///< assets received from limit orders
   share_type           limit_order_USD_paid = 0;                 ///< USD paid by limit orders
   share_type           limit_order_USD_received = 0;             ///< USD received by limit orders
...
struct account_activity_bucket_object : public object< account_activity_bucket_object_type, account_activity_bucket_object >
{
   ...
   fc::time_point       open;                                  ///< Open time for the bucket
   uint32_t             seconds = 0;                           ///< Seconds accounted for in the bucket
...
FC_REFLECT( node::account_statistics::account_stats_bucket_object,
   ...
   (assets_received_from_withdrawls)
   (assets_received_from_routes)
   (assets_received_from_routes)
   (limit_orders_created)
   (limit_orders_filled)
   (limit_orders_cancelled)
   (limit_order_assets_paid)
   (limit_order_assets_received)
   (limit_order_USD_paid)
   (limit_order_USD_received)
   (total_pow)
   (estimated_hashpower)
)
