...
BOOST_AUTO_TEST_CASE( mh_test )
{
   ...
   try
   {
      ...
      BOOST_REQUIRE( bucket->USD_volume == ASSET( "0.500 USD" ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->USD_volume == ASSET( "1.500 USD" ).amount );
      bucket++;
